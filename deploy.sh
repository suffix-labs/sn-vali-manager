...
echo "- Suffix Validator Grafana: kubectl port-forward -n starknet-node svc/grafana-suffix-validator-service 3001:3001"
echo "- Ethchi Validator Grafana: kubectl port-forward -n starknet-node svc/grafana-ethchi-validator-service 3002:3002"
echo ""
echo "Credentials:"
echo "- Admin Grafana: admin/admin123"
echo "- Suffix Validator Grafana: admin/suffix-validator-pass123 (or anonymous viewer access)"
echo "- Ethchi Validator Grafana: admin/ethchi-validator-pass123 (or anonymous viewer access)"
echo ""
